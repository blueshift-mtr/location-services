...
public class LocationUpdateService 
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            builder.setSmallIcon(getPluginResource("fb_yel"));
...
//        Log.i(TAG, "- locationTimeout: "    + locationTimeout);
    ...
    private BroadcastReceiver locationUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                ...
                if(isDebugging) {
                    Toast.makeText(context, "We recieveived a location update" + location.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void onConnectionFailed(com.google.android.gms.common.ConnectionResult result) {
        Log.e(TAG, "We failed to connect to the Google API!");
    }
